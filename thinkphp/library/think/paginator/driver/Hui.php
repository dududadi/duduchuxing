...
class Hui extends Paginator
{
    ...
    protected  function totalshow()
    {
        ...
        $totalhtml="<li class=\"btn disabled radius\"><span>共".$this->total."条记录&nbsp&nbsp第".$this->currentPage()."页/共".$this->lastPage()."页</span></li>";
        return $totalhtml;
    ...
    {
        return '<li style="display: inline-block" ><a class="btn radius" style="width: 100%;height: 100%" href="' . htmlentities($url) . '">' . $page . '</a></li>';
    }
    ...
    {
        return '<li class="btn disabled radius"><span>' . $text . '</span></li>';
    }
    ...
    {
        return '<li class="btn  radius" style="color: #fff;background-color: #3bb4f2;border-color: #3bb4f2;"><span>' . $text . '</span></li>';
    }
